package com.starwars.flow.detail.starships.view
...
import com.starwars.databinding.FragmentStarshipsBinding
...
class StarShipFragment:BaseFragment(),IView{
    private lateinit var mBinding: FragmentStarshipsBinding
    private val mViewModel: StarViewModel
            by lazy {
    ...
    companion object {
        const val TAG = "STARSHIP_FRAGMENT"
        fun newInstance() = StarShipFragment()
    }

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_starships,
            container, false)
